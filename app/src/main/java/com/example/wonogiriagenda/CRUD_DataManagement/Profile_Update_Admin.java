...
public class Profile_Update_Admin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(Profile_Update_Admin.this, "Fail to get data.", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(Profile_Update_Admin.this);
                // set title dialog
                        ...
                        .setPositiveButton("Ya", (dialog, id) -> {
                            ...
                            mDatabase.child(cekUsername).setValue(dataRegister).addOnSuccessListener(new OnSuccessListener<Void>() {
                                ...
                                public void onSuccess(Void aVoid) {
                                    Toast.makeText(Profile_Update_Admin.this, "Update Berhasil.",
                                            Toast.LENGTH_SHORT).show();
                                }
                            });
                            String send_username = username;
                            Intent menu = new Intent(Profile_Update_Admin.this, AdminActivity.class);
